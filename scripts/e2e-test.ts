...
async function main() {
  ...
  try {
    const sdk = await import("../packages/agentkit-guardrails/dist/index.mjs");
  ...
  try {
    const { getPolicyModel } = await import("../packages/agentkit-guardrails/dist/index.mjs");
  ...
  try {
    const { createAttestationData, computeAttestationHash, PolicyDecision } = await import(
      "../packages/agentkit-guardrails/dist/index.mjs"
    );
  ...
  try {
    const { checkAction, PolicyDecision } = await import("../packages/agentkit-guardrails/dist/index.mjs");
